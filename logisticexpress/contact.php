...
<main>
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" method="post" action="./utils/send_contact.php">
			...
			<div class="contact100-more flex-col-c-m" >
				<div class="flex-w size1 p-b-47">
					...
					<div class="flex-col size2">
						<span class="txt1 p-b-20">
							Halitrephes is a Virginia Limited Liability Corporation, Small Business Concern and self-certified, Service-Disabled, Veteran-Owned, SmallBusiness (SDVOSB) located in Northern Virginia just 90 minutes from Washington DC.
						</span>
				...
				<div class="flex-w size1 p-b-47">
					<div class="txt1 p-r-25">
						<span class="lnr lnr-map-marker" style="color:#2268DD;    font-weight: 1000;">
						</span>
					</div>

					<div class="flex-col size2">
						<span class="txt1 p-b-20">
							21 NORTH BROAD STREET, SUITE D, LURAY, VA 22835
						</span>
				...
				<div class="dis-flex size1 p-b-47">
					<div class="txt1 p-r-25">
						<span class="lnr lnr-phone-handset" style="color:#2268DD;    font-weight: 1000;"></span>
					</div>
				...
				<div class="dis-flex size1 p-b-47">
					<div class="txt1 p-r-25">
						<span class="lnr lnr-envelope" style="color:#2268DD;    font-weight: 1000;"></span>
					</div>

					<div class="flex-col size2">
						<span class="txt1 p-b-20">
							info@halitrephes.com
						</span>
